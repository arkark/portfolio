          ...
          children: [
            {
              id: "5-1",
              label:
                "アルゴリズム、データ構造、グラフ理論、代数、圏論、分散システム、ネットワーク、組合せ最適化、論理学",
              children: [
                {
                  id: "5-1-1",
          ...
          children: [
            {
              id: "6-1",
              label:
                "シェーダ、ビジュアライゼーション、ジェネラティブデザイン、サイバーセキュリティ、データベース"
            }
          ]
        },
        {
